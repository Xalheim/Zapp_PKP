...
$plugin = new Plugin();
if (!$plugin->isInstalled('softplg') || !$plugin->isActivated('softplg')) {
...
if (isset($_POST['add'])) {
   ...
   Html::redirect("{$CFG_GLPI['root_doc']}/plugins/softplg/front/softplg.form.php?id=$newid");
   ...
   //Redirect to objects list
   Html::redirect("{$CFG_GLPI['root_doc']}/plugins/softplg/front/softplg.php");
} else {
